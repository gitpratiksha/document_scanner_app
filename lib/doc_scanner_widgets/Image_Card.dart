...
import 'package:myscan/doc_scanner_screens/view_document.dart';
            ...
            menuItems: [
              FocusedMenuItem(
                ...
                onPressed: () async {
                  ...
                  //  print(widget.imageOS.imgPath.toString());
                  String imageFilePath =  await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) =>ImageCropper(imageFile:widget.imageOS.imgPath ,)
                        ),
                      );
