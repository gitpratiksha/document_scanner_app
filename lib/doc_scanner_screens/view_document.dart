...
import 'package:myscan/doc_scanner_utilities/file_operations.dart';
import 'package:myscan/doc_scanner_widgets/FAB.dart';
import 'package:myscan/doc_scanner_widgets/crop_image.dart';
import 'package:myscan/doc_scanner_widgets/Image_Card.dart';
...
class _ViewDocumentState extends State<ViewDocument>
  ...
  var _optionsTextStyle=TextStyle(
    color: Colors.white
  );
  ...
  Future<void> createDirectoryPath() async {
    ...
    dirPath = "${appDir.path}/onescan ${DateTime.now()}";
                                  ...
                                  return [
                                    PopupMenuItem(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text('Select',style: _optionsTextStyle,),
                                          SizedBox(width: 10),
                                          Icon(
                                            Icons.select_all,
                                            size: 20,
                                    ...
                                    PopupMenuItem(
                                      ...
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
                                        children: [
                                          Text('Export',style:_optionsTextStyle),
                                          SizedBox(width: 10),
                                          Icon(
                                            Icons.share,
                                            size: 20,
